...
public interface ProductBasicsInfoService {
	 ...
	 */
	PageVO<ProductBasicsInfoDTO> pageQueryProductByParam(ProductQueryDTO productQueryDTO);
	 ...
	 */
	PageVO<ProductSpuVO> managePageQuerySpuByParam(QuerySpuRequest querySpuRequest);
