...
//						.areaName()
			...
			// 获取供应商的包邮邮费设置
			StorePostageEntity.SupplierFreePostageInfo supplierFreePostageInfo = supplierIdFreePostageMap.getOrDefault(supplierId, new StorePostageEntity.SupplierFreePostageInfo());
			// 组装供应商的邮费返回值
...
//					.supplierTypeName()
					.freePostage(BigDecimalUtil.F2Y(supplierFreePostageInfo.getFreePostage()))
