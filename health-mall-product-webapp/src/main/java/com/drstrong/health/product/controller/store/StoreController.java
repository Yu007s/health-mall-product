...
public class StoreController implements StoreFacade {
    ...
    @PostMapping("/save")
    public ResultVO<String> savaStore(@RequestBody @Valid StoreInfoDetailVO store, @RequestParam String userId) {
    ...
    public ResultVO<StoreInfoDetailVO> queryStoreDetail(@RequestParam Long storeId) {
        StoreInfoDetailVO storeInfoDetailVO = storeService.queryById(storeId);
        return ResultVO.success(storeInfoDetailVO);
    }
