...
public class PageVO<T> implements Serializable {
     ...
     * @param currPage   当前页数
     */
    private PageVO(List<T> list, Long totalCount, int pageSize, int currPage) {
        this.list = list;
...
//    }
    ...
    public static <T> PageVO<T> toPageVo(List<T> list, Long totalCount, int pageSize, int currPage) {
